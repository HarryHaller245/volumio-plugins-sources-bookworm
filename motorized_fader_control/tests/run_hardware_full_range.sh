...
# Hardware full range test runner
# Tests max speed to verify faders reach full 0-100 range
...
echo "Hardware full range test at max speed"
...
cd "$PLUGIN_DIR"
node test_hardware_full_range.js "$@"
